...
if sys.path[0] != str(root_dir): sys.path.insert(0, str(root_dir))
# st.write(sys.path[0])

from rs.st_page.streamlit_styling import styling
from rs.generate_st_html.generate_html_funcs import CSS
from rs.st_page.Home import (
    NEGATIVE_HEADS,
    HTML_PLOTS_FILENAME
)
...
This page allows you to browse through a large set of OpenWebText prompts, and see how negative heads behave on the different tokens in those prompts. It should help build your intuition about how much of the negative heads' behaviour is copy-suppression, and when this is good/bad.
